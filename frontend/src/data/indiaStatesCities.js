/**
 * India states/UTs with major cities, for cascading State -> City select
 * dropdowns. Covers all 28 states + 8 union territories with their
 * state capitals and other major tier-1/tier-2 cities - not an exhaustive
 * list of every town, but enough for standard business registration forms.
 * Extend per-state arrays below if you need finer coverage.
 */
